defmodule GeneticsEngine.Numina.NumenSupervisor do
  ...
  def start_numen(supervisor, numen_module, agent_id) do
    ...
    ontos_pid = case Registry.lookup(GeneticsEngine.Onta.OntosRegistry, agent_id) do
      [{pid, _}] -> pid
      _ -> nil
    end
  ...
  defp via_tuple(agent_id) do
    {:via, Registry, {GeneticsEngine.Registry, {__MODULE__, agent_id}}}
  end
end
